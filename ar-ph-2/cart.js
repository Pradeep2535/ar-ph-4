...
const name1 = "Pradeep S";
const phoneNumber = "+91 8838909289";
const message = `Name : ${name1}\nPhone : ${phoneNumber}\n\nOrder Details:\n   1. Onion Dosaqqqqqqqqqqqqqqqqqqqqqqqqqqqq\n   2. Burger\n   3. Chicken Pizza`;
console.log(message);
const secondMessage = '--------------------------------------------------------------------';
encodedMessage = encodeURIComponent(message);

const apiURL =
  `https://s12j4nb21k.execute-api.ap-south-1.amazonaws.com/message/telFunc?token=7274047456:AAFlt1ylqNDj2Nbq-ddOaw9rnz-N-DF4RoE&chat_id=-4542112220&message=${encodedMessage}`;
